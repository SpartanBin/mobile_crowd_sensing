...
class ID_allID_DNN_structure1(nn.Module):
    ...
    def __init__(self, conv_params: list, add_BN: bool, output_dim: list, share_params: bool):
        ...
        dnn = []
        if add_BN:
            dnn.append(nn.BatchNorm1d(448 + 442 * 2))
        dnn.append(nn.Linear(448 + 442 * 2, 256))
        if add_BN:
            dnn.append(nn.BatchNorm1d(256))
        dnn.append(nn.ELU())
        dnn.append(nn.Linear(256, 128))
        if add_BN:
...
class ID_allID_DNN_structure2(nn.Module):
    ...
    def __init__(self, conv_params: list, add_BN: bool, output_dim: list, share_params: bool):
        ...
        :return:
        '''
        super(ID_allID_DNN_structure2, self).__init__()
