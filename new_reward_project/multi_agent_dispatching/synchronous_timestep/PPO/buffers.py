...
class RolloutBuffer():
    ...
    def reset(self) -> None:
        self.vehicle_states = np.zeros((self.buffer_size, self.vehicle_num, 3), dtype=np.float32)
    ...
    def add(
        ...
        :param log_prob: log probability of the action
            following the current policy.
        """
        vehicle_states, node_weight, grid_cover, p = obs

        self.vehicle_states[self.pos] = vehicle_states.copy()
